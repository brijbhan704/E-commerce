...
<head>
    ...
    <link href="{{asset('frontend/ss/responsive.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +91 8573992385</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> tiwari0186@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                              ...
                              <?php  if($customer_id != NULL) { ?>
                                <li><a href="{{URL::to('/customer_logout')}}"></i> Logout</a></li>

                               <?php }elseif($customer_id != NULL && $shipping_id != NULL){ ?>
                                <li><a href="{{URL::to('login_check')}}"></i> Login</a></li>
                                <?php }else{ ?>
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->             
                            <?php 
                            $categories = DB::table('tbl_category')->where('publication_status',1)->OrderBy('category_id','DESC')->get();
                            foreach ($categories as $key => $category) {                   
                            ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/category_by_product/'.$category->category_id)}}">{{$category->category_name}}</a></h4>
                                </div>
                            </div>
                            <?php
                             }
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                 <?php 
                            $brands = DB::table('tbl_manufacture')->where('publication_status',1)->OrderBy('manufacture_id','DESC')->get();
                            foreach ($brands as $key => $brand) {                   
                            ?>
                                <ul class="nav nav-pills nav-stacked">                            
                                    <li><a href="{{URL::to('/manufacture_by_product/'.$brand->manufacture_id)}}"> <span class="pull-right"></span>{{$brand->manufacture_name}}</a></li>
                                </ul>
                                <?php
                             }
                            ?>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <p class="pull-right">Designed by <span><a target="_blank" href="#">Brijbhan Tiwari</a></span></p>
                </div>
            </div>
        </div>
