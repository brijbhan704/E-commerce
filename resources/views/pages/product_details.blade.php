					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{URL::to($all_product->product_image)}}" alt="" />
								<h3>ZOOM</h3>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Color:</b> {{$all_product->product_color}}</p>
								...
								<span>
									...
									<form action="{{URL::to('add_to_cart')}}" method="post" >
										{{@csrf_field()}}
											...
											<input type="hidden" name="product_id" value="{{$all_product->product_id}}">
								...
								<p><b>Brand:</b> {{$all_product->manufacture_name}}</p>
								<p><b>Category:</b> {{$all_product->category_name}}</p>
								<p><b>Size:</b> {{$all_product->product_size}}</p>
